...
def compute_keys(parent_private_key:bytes, parent_chain_code:bytes, child_index:int, is_hardened:bool)-> tuple[bytes,bytes]:
    if is_hardened:
...
# Level 0 Purpose
level0_private_key, level0_chain_code = compute_keys(master_private_key, master_chain_code, 84, True)

# Level 1 Coin Type
level1_private_key, level1_chain_code = compute_keys(level0_private_key, level0_chain_code, 0, True)

# Level 2 Account
level2_private_key, level2_chain_code = compute_keys(level1_private_key, level1_chain_code, 0, True)

# Level 3 Change
level3_private_key, level3_chain_code = compute_keys(level2_private_key, level2_chain_code, 0, False)

# Level 4 Index
level4_private_key, level4_chain_code = compute_keys(level3_private_key, level3_chain_code, 0, False)
